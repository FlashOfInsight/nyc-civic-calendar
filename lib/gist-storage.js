...
//
// Env vars are read at call time (not module load) so this module works in
// both Node.js (Vercel, GitHub Actions) and Cloudflare Pages Functions,
// where process.env is populated via the nodejs_compat flag.
...
function getGistRawUrl(filename) {
  return `https://gist.githubusercontent.com/${GITHUB_USERNAME}/${process.env.GIST_ID}/raw/${filename}`;
}
