...
function createMeeting(boardId, title, dateStr, time, location, url, borough = "manhattan") {
  // Strip redundant "CB#:" or "CB# " prefixes and deduplicate repeated phrases
  // e.g. "CB2: Executive Committee" → "Executive Committee", "Board Meeting Board Meeting" → "Board Meeting"
